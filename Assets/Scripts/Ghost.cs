...
public class Ghost : MonoBehaviour
{
    ...
    pubblic bool isInGhostHouse = false;

    public Node starting Position;
    ...
    Vector2 GetBlueGhostTargetTile()
    {
        ...
        int pacManPositionX = Mathf.RoundToInt(tempBlinkyPosition.x);
        int pacManPositionY = Mathf.RoundToInt(tempBlinkyPosition.y);
